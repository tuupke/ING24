...
<div id="main">
    ...
    <div id="inner">
        ...
        <div class="block">
            <h1>Pay</h1>
            <p><a href="?message=A payment of €20,- has been classified as groceries">Classified</a></p>
            <p><a href="?message=A payment of €20,- could not be classified.">Unclassified</a></p>
        </div>
        </div>
    </div>
</div>
